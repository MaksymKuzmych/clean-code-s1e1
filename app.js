...
const taskInput = document.getElementById('task__text') //Add a new task.
const addButton = document.getElementById('task__btn') //first button
...
let createNewTaskElement = function (taskString) {
  ...
  listItem.className = 'incomplete-tasks__item item'
...
let editTask = function () {
  ...
  let editInput = listItem.querySelector('.item__text')
  let label = listItem.querySelector('.item__label')
  let editBtn = listItem.querySelector('.item__edit')
...
function bindTaskEvents(taskListItem, checkBoxEventHandler) {
  ...
  let editButton = taskListItem.querySelector('.item__edit')
  let deleteButton = taskListItem.querySelector('.item__delete')
